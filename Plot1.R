...
#plot and store first one
png(file = "plot1.png", width = 480, height = 480)
hist(as.numeric(as.character(DataCooked$Global_active_power)),col = "red", xlab = "Global Active Power (kilowatts)", main="Global Active Power")
dev.off()